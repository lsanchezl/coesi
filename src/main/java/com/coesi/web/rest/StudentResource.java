...
import com.coesi.service.StudentService;
...
/**
 * REST controller for managing {@link com.coesi.domain.Student}.
 */
@RestController
@RequestMapping("/api")
public class StudentResource {
     ...
     * with body the new student, or with status {@code 400 (Bad Request)} if
     ...
     * body the updated student, or with status {@code 400 (Bad Request)} if the
     * student is not valid, or with status {@code 500 (Internal Server Error)}
     * if the student couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/students")
     ...
     * list of students in body.
     */
    @GetMapping("/students")
    public ResponseEntity<List<Student>> getAllStudents(Pageable pageable) {
        log.debug("REST request to get a page of Students");
        Page<Student> page = studentService.findAll(SecurityUtils.getUserDTO(), pageable);
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with
     * body the student, or with status {@code 404 (Not Found)}.
     */
