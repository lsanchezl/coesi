...
import com.coesi.service.RoomService;
...
/**
 * REST controller for managing {@link com.coesi.domain.Room}.
 */
@RestController
@RequestMapping("/api")
public class RoomResource {
     ...
     * with body the new room, or with status {@code 400 (Bad Request)} if the
     ...
     * body the updated room, or with status {@code 400 (Bad Request)} if the
     * room is not valid, or with status {@code 500 (Internal Server Error)} if
     * the room couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/rooms")
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with
     * body the room, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/rooms/{id}")
