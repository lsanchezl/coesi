...
import com.coesi.service.MailService;
import org.springframework.data.domain.Sort;
import java.util.Collections;
import com.coesi.service.UserService;
import com.coesi.service.dto.UserDTO;
import com.coesi.web.rest.errors.BadRequestAlertException;
import com.coesi.web.rest.errors.EmailAlreadyUsedException;
import com.coesi.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
     ...
     */
    @PostMapping("/users")
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.SECRETARY + "\")")
    ...
    @GetMapping("/users/list/no-students")
    public List<User> getUsersListNoStudents() {
        return userService.getUsersListNoStudents();
    }
    
    @GetMapping("/users/list/no-teachers")
    public List<User> getUsersListNoTeachers() {
        return userService.getUsersListNoTeachers();
    }
